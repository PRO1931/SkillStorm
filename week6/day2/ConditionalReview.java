...
public class ConditionalReview {
	...
	//Return a P or F depending on whether they passed or failed
	...
	public static void determineDailyPlanWithoutSwitch(String weatherForToday) {
		/*
		 * If weather is sunny or partly cloudy, I will go to the beach
		 * If it's rainy, I will put on a movie
		 * If it's snowing, I will go skiiing
		 */

...
let artists = ['Picasso', 'Leonardo DaVinci', 'Donatello', 'Micaelangelo', 'Raphael'];
...
// I can also use for og loops to iterate over our strings 
for (let char of str){
    console.log(char);
}

//For in loop for a string works the same as arrays
// Works by enumerating over the indices of the array

...
/**
 *  To remove the unexpected behavior fromo ==, === was added
 * 
 *  === (Strict Equality Operator)
 *  - to determine equality, it takes both the type AND the value into consideration
 *  - it does an additional step first of:
 *     typeof 2 == typeof '2'
 *     'number' == 'string'
 */
 ...
 *      -We use the second ! to invert back to its logical boolean value (if truthy then true, if falsey then false)
 */
...
// If the left side is false, JS does not evaluate the right hand side since there' no point.
// Since the left side is False, the entire comparison is False
...
function printArray(arr){
    arr = arr || [];  //if the arr provided is false, use an empty array instead
...
//Using || and && for assignment is similar to a ternary operatior

/**
 * Arraysin JavaScript are slightly different from Arrays in Java
 * 
 * JS Arrays:
...
//Unshift addsan element tothe front ofthe array
...
//We can also get the indexofaspecific value using indexOf
...
//I can change the cone without changing the original
let fruitClone = fruits.slice();
fruitClone.pop();
fruitClone.pop();

console.log('The value of fruitClone is:', fruitClone);
console.log('the value of the original fruits array is:', fruits);

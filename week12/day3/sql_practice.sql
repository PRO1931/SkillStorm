...
Commands:
    ...
    GROUP BY - Allows us to group our rows that we get back logically (group by first name)
...
/* 
    ...
    Date/Time:
        ...
        YEAR
            ...
            4 Digits allows us to enter the year of my choosing
...
-- Snake Case: there_is_a_snake_in_my_boot (Python)
-- Camel Case: thereIsASnakeInMyBoot (Java)

-- WHERE clause
-- SELECT data FROM table WHERE condition

-- Give me all the data from actor so long as the actor_id is greater than 10
SELECT * FROM actor WHERE actor_id > 10;

-- give me all the rows so long as the actor's first name is Nick
SELECT * FROM actor WHERE first_name = 'Nick';

-- give me just Nick Stallone from the table of actors
SELECT * FROM actor WHERE first_name = 'Nick' AND last_name = 'Stallone';-- This is a single line comment

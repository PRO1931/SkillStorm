...
console.log(shape); // has a property of color that is undefined since I called the constructor with no parameters
...
cat.__proto__.speak();  //cat.__proto__ is pointing to Cat's prototype speak function

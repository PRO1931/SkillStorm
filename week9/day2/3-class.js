/**
 * In 2015, EcmaScript 6 was released and with it, a whole host of changes were added to the JS language
 * 
 * Among these was the beloved class syntax
 * 
 * Important to note:
 *  - Classes in JS are just "syntactic sugar" for constructor functions
...
class Bird {
    // Here we can define properties of a bird
    // Using # we indicate that this is a private field
    #color;        // # makes the property private
    wingSpan = 20; // Assign default value to wingSpan

    //Constructor for Bird
    //In JS, we can only have one constructor since overloading doesn't exist
    constructor(color, wingSpan){
        ...
        this.wingSpan = wingSpan ?? 20;  // Sets the value to 20 if wingSpan is either null or undefined, otherwise to wingSpan predefined
    }
    ...
    // Gettters/Setters are super easy with classes
    get color() {
...
class Raven extends Bird {
    constructor(color, wingSpan) {
        ...
        super(color, wingSpan);     //super cals the parent constructor
    }

...
const dog = new Dog();  // dog.__proto__ -> Dog.prototype

/**
 * The check for 'legs' property goes like this:
 * 1. Does the current dog object have a property called 'legs'? (If so, use that and skip the other steps)
 * 2. If not, check the dog.__proto__property for a property called 'legs' (If found, use that and skip the rest)
